...
Cold-cache disks, network/removable volumes, cloud providers, and live SwiftUI interaction latency remain unmeasured. Findings 4–5 and the decoded-native-name portion of finding 3 remain unimplemented and unbenchmarked. Incremental rescans already localize disk reads, but their sequential deep-subtree rescans and whole-store splice remain separate follow-up profiling targets; this audit did not measure those paths.
